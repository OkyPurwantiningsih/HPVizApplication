...
public class HPParser4 {
	public static void main(String[] args) throws IOException {
		
		// ====================================
		// version of HPParser where game general information is also extracted from the log file
		// ====================================
        ...
        JsonGenerator generator = factory.createGenerator(new FileWriter(new File("file1AllInfo.json")));
